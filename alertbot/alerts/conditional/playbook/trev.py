...
# ---------------------------------- Specific Calculations ------------------------------------ #   
    def exp_range(self):
        logger.debug(f" TREV | exp_range | Product: {self.product_name} | Note: Running")
    ...
    def total_delta(self):
        logger.debug(f" TREV | total_delta | Product: {self.product_name} | Note: Running")
...
# ---------------------------------- Driving Input Logic ------------------------------------ #   
    def input(self):
        logger.debug(f" TREV | input | Product: {self.product_name} | Note: Running")
...
# ---------------------------------- Opportunity Window ------------------------------------ #   
    def time_window(self):
        logger.debug(f" TREV | time_window | Product: {self.product_name} | Note: Running")
...
# ---------------------------------- Calculate Criteria ------------------------------------ #      
    def check(self):
        logger.debug(f" TREV | check | Product: {self.product_name} | Note: Running")
...
# ---------------------------------- Alert Preparation------------------------------------ #  
    def discord_message(self):
        logger.debug(f" TREV | discord_message | Product: {self.product_name} | Note: Running")
    ...
    def execute(self):
        logger.debug(f" TREV | execute | Product: {self.product_name} | Note: Running")
        ...
        if webhook_url:
            ...
            logger.debug(f" TREV | execute | Product: {self.product_name} | Note: No Discord Webhook Configured")
