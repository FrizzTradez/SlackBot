...
# ---------------------------------- Specific Calculations ------------------------------------ #   
    def exp_range(self):
        logger.debug(f" TRCT | exp_range | Product: {self.product_name} | Note: Running")
    ...
    def total_delta(self):
        logger.debug(f" TRCT | total_delta | Product: {self.product_name} | Note: Running")
...
# ---------------------------------- Opportunity Window ------------------------------------ #   
    def time_window(self):
        logger.debug(f" TRCT | time_window | Product: {self.product_name} | Note: Running")
...
# ---------------------------------- Calculate Criteria ------------------------------------ #      
    def check(self):
        logger.debug(f" TRCT | check | Product: {self.product_name} | Note: Running")
...
# ---------------------------------- Alert Preparation------------------------------------ #  
    def discord_message(self):
        logger.debug(f" TRCT | discord_message | Product: {self.product_name} | Note: Running")
    ...
    def execute(self):
        logger.debug(f" TRCT | execute | Product: {self.product_name} | Note: Running")
