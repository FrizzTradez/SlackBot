external_data = [
    {"sheet_name": "ES_Data", "sheet_id": "1miVoDpHI40Nff7PZB5QVKAGaB-QaGEJzijo8uf2wtCU", "row_number": 17, "col_number": 130}, # FIX PLZ
...
es_2 = [
    ...
    '[ID8.SG4] P_MCLOSE', '[ID12.SG1] P_MVPOC', '[ID1.SG1] MVWAP', '[ID7.SG1] ETH VWAP', 
...
columns_to_drop = [
    "Date Time", "[ID0.SG1] Open", "[ID0.SG2] High", "[ID0.SG3] Low", "[ID0.SG4] Last", 
